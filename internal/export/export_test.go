...
func TestBuildBundlesUsesKnownSiteArticlePrefixes(t *testing.T) {
	...
	mapper := reviewjson.Mapper{
		ProductLinks: map[string]string{"6202": "https://example-shop.test/products/p-6202"},
	}
...
func TestBuildLinkIndexMapsEveryPathAndIDToArticle(t *testing.T) {
	links := []site.ProductLink{
		...
		{SellerArticle: "1777-5", URL: "https://example-shop.test/products/plate-naryadnoe-ofisnoe-suhaya-roza-102291"},
		{SellerArticle: "1777-5", URL: "https://example-shop.test/products/plate-naryadnoe-cvet-1-bejevyiy-100635/"},
		{SellerArticle: "3453", URL: "https://example-shop.test/products/plate-naryadnoe-v-stile-boho-temno-biryzovyiy-102277"},
		// No article → skipped entirely.
		{SellerArticle: "", URL: "https://example-shop.test/products/no-article-100000"},
		// Non-numeric tail → kept in byPath, absent from byID.
		{SellerArticle: "55", URL: "https://example-shop.test/products/slug-without-id"},
	}
